...
<link rel="stylesheet" type="text/css"
	href="../resources/MH/bootstrap/css/bootstrap.css">
					...
					<div class="col-4">
						...
						<c:choose>
							...
							<c:when test="${smbm ne 0}">
								<button id="like" value="O"
									style="margin-left: 80%; border: none; background-color: white;">
									<img id="likeO" alt="" src="../resources/MH/images/likeO.png">
								</button>
								<c:set var="sw" value="O" />
							</c:when>
							<c:otherwise>
								<button id="like" value="X"
									style="margin-left: 80%; border: none; background-color: white;">
				...
				<div class="col-sm-4">
					<div class="card">
						<img class="card-img-top rounded mx-auto d-block"
							src="${product.pImg }" alt="pImg" style="width: 20rem;">
						<div class="card-body mx-auto d-block">
							...
							<a href="${product.prodUrl}"><p
									class="card-text mx-auto d-block">상품 페이지로 이동</p></a>
						</div>
					</div>
				</div>
			</c:forEach>
