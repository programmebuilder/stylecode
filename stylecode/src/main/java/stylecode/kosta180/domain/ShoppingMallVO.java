...
public class ShoppingMallVO implements Serializable {
	...
	public ShoppingMallVO(int spmEnrollNo, String spmNm, String spmURL, String spmTn, String spmInfo, int spmViews,
	...
	public String toString() {
		return "ShoppingMall [spmEnrollNo=" + spmEnrollNo + ", spmNm=" + spmNm + ", spmURL=" + spmURL + ", spmTn="
