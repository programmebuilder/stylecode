...
<head>
	...
	<!-- 내부 자바스크립트 -->
	<script src="/resources/sns/js/jquery-3.3.1.js"></script>
...
<body id="sns">
	...
	<header class="text-right">
		...
		<div class="second-icon dropdown menu-icon">
			<span class="dropdown-toggle" role="button" id="dropdownNotification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <span class="hidden-xs hidden-sm">Notifications</span> <i class="far fa-bell" aria-hidden="true"></i> <span class="badge">2</span>
			</span>
